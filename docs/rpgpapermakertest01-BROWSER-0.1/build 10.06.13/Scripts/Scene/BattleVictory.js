...
class BattleVictory {
    ...
    initialize() {
        ...
        for (id in this.battle.currencies) {
            Game.current.currencies.set(Number(id), Game.current.currencies.get(Number(id)) + this.battle.currencies[id]);
            if (this.battle.currencies[id] > 0) {
                Game.current.currenciesEarned.set(Number(id), Game.current.currenciesEarned.get(Number(id)) + this.battle.currencies[id]);
            }
            else {
                Game.current.currenciesUsed.set(Number(id), Game.current.currenciesUsed.get(Number(id)) - this.battle.currencies[id]);
            }
        }
