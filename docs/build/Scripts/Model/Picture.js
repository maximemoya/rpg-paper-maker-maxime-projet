...
class Picture extends Base {
        ...
        for (let i = 0; i < l; i++) {
            ...
            if (x === 3) {
                ...
                if (leftSquare === null && rightSquare === null) {
                    ...
                    if (!square) {
                        Platform.showErrorMessage(`Your wall image ${this.name} is not using a correct template. 
    ...
    getSquaresForStates(image) {
        ...
        const states = new Array(Data.Systems.FRAMES * 4);
