...
class Object3DBox extends Object3D {
     ...
     */
    getCenterVector() {
        return new THREE.Vector3(this.datas.widthPixels() / 2, this.datas.heightPixels() / 2, this.datas.depthPixels() / 2);
    }
    /**
    ...
    updateGeometry(geometry, position, count) {
        ...
        for (let i = 0; i < Object3DBox.NB_VERTICES; i += 4) {
            ...
            texA = new THREE.Vector2(textures[tA[0]], textures[tA[1]]);
