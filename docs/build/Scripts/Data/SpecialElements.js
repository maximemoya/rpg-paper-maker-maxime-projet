...
import { Autotile, Mountain, Object3D, SpecialElement, } from '../Model/index.js';
...
export class SpecialElements {
            ...
            for (let b = 0; b < Autotiles.COUNT_LIST; b++) {
                ...
                for (let c = 0; c < Autotiles.COUNT_LIST; c++) {
                    ...
                    for (let d = 0; d < Autotiles.COUNT_LIST; d++) {
                        ...
                        // Draw
                        Platform.ctxr.drawImage(img, (lA % 4) * sDiv + offsetX, Math.floor(lA / 4) * sDiv + offsetY, sDiv, sDiv, count * Data.Systems.SQUARE_SIZE, (row + y) * Data.Systems.SQUARE_SIZE, sDiv, sDiv);
                        Platform.ctxr.drawImage(img, (lB % 4) * sDiv + offsetX, Math.floor(lB / 4) * sDiv + offsetY, sDiv, sDiv, count * Data.Systems.SQUARE_SIZE + sDiv, (row + y) * Data.Systems.SQUARE_SIZE, sDiv, sDiv);
                        Platform.ctxr.drawImage(img, (lC % 4) * sDiv + offsetX, Math.floor(lC / 4) * sDiv + offsetY, sDiv, sDiv, count * Data.Systems.SQUARE_SIZE, (row + y) * Data.Systems.SQUARE_SIZE + sDiv, sDiv, sDiv);
                        Platform.ctxr.drawImage(img, (lD % 4) * sDiv + offsetX, Math.floor(lD / 4) * sDiv + offsetY, sDiv, sDiv, count * Data.Systems.SQUARE_SIZE + sDiv, (row + y) * Data.Systems.SQUARE_SIZE + sDiv, sDiv, sDiv);
                        count++;
                        if (count === 64) {
                            count = 0;
                            row++;
    ...
    static async loadTextureWall(picture, id) {
        ...
        // Check if correct format size
        this.checkPictureSize('wall', picture.name, picture2D.image.width, picture2D.image.height, 3 * Data.Systems.SQUARE_SIZE, Data.Systems.SQUARE_SIZE, true, false);
        ...
        const right = Platform.ctxr.getImageData(w - Math.floor(Data.Systems.SQUARE_SIZE / 2), 0, Math.floor(Data.Systems.SQUARE_SIZE / 2), picture2D.image.height);
        try {
    ...
    static async loadTextureMountain(textureMountain, texture, picture, offset, id) {
        ...
        const size = 9;
        // Check if correct format size
        this.checkPictureSize('mountain', picture.name, picture2D.image.width, picture2D.image.height, 3 * Data.Systems.SQUARE_SIZE, 3 * Data.Systems.SQUARE_SIZE, true, true);
        // Update picture width and height for collisions settings
        if (picture) {
            picture.width = width;
            picture.height = height;
    ...
    static paintPictureMountain(img, offset, id) {
        ...
        try {
            for (let i = 0; i < 3; i++) {
                Platform.ctxr.drawImage(img, 0, i * Data.Systems.SQUARE_SIZE, sDiv, Data.Systems.SQUARE_SIZE, sourceSize, y + i * Data.Systems.SQUARE_SIZE, sDiv, Data.Systems.SQUARE_SIZE);
                Platform.ctxr.drawImage(img, sourceSize - sDiv, i * Data.Systems.SQUARE_SIZE, sDiv, Data.Systems.SQUARE_SIZE, sourceSize + sDiv, y + i * Data.Systems.SQUARE_SIZE, sDiv, Data.Systems.SQUARE_SIZE);
            }
            // Add top/bot autos
            for (let i = 0; i < 3; i++) {
                Platform.ctxr.drawImage(img, i * Data.Systems.SQUARE_SIZE, 0, Data.Systems.SQUARE_SIZE, sDiv, i * Data.Systems.SQUARE_SIZE, y + sourceSize, Data.Systems.SQUARE_SIZE, sDiv);
                Platform.ctxr.drawImage(img, i * Data.Systems.SQUARE_SIZE, sourceSize - sDiv, Data.Systems.SQUARE_SIZE, sDiv, i * Data.Systems.SQUARE_SIZE, y + sourceSize + sDiv, Data.Systems.SQUARE_SIZE, sDiv);
            }
            // Add all sides autos
            ...
            for (let i = 0; i < 3; i++) {
                for (let j = 0; j < 4; j++) {
                    Platform.ctxr.drawImage(img, Data.Systems.SQUARE_SIZE, i * Data.Systems.SQUARE_SIZE, Data.Systems.SQUARE_SIZE, Data.Systems.SQUARE_SIZE, j * Data.Systems.SQUARE_SIZE, (4 + i) * Data.Systems.SQUARE_SIZE, Data.Systems.SQUARE_SIZE, Data.Systems.SQUARE_SIZE);
                }
            }
        }
        catch {
...
SpecialElements.texturesAutotiles = new Map();
SpecialElements.texturesWalls = new Map();
SpecialElements.texturesObjects3D = new Map();
SpecialElements.texturesMountains = new Map();
